package com.jenny.shopping.core.system;

import com.jenny.shopping.core.util.SystemInfoPrinter;
import com.jenny.shopping.db.service.LitemallSystemConfigService;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.com.jenny.shopping.wx"));
